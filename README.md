# python-cli-elasticsearch-multi-node-client-dsl-orm-without-ssl-pop

## Description
Models, based on elasticsearch dsl orm, into a multi node cluster for data in `pop-demo` document.
